// Generated by tools/generate_standalone_processor.py from
// /home/sdcnlab/GazeboRL/envs/processors/trajectory_tracking_processor.hh. Do not edit this generated copy by hand.
#ifndef STANDALONE_TRAJECTORY_TRACKING_PROCESSOR_HH_
#define STANDALONE_TRAJECTORY_TRACKING_PROCESSOR_HH_

#include "trajectory_tracking_reference.hh"
...
public:
        ...
        State &processed_obs)
    {
        ...
        auto &observation = processed_obs["obs"];
        observation.resize(ExpectedObservationDimension());
        int index = 0;
        auto append = [&](float value)
        {
            ...
            observation[index++] = Sanitize(value);
        };
    ...
    {
        const Eigen::VectorXf &action_data =
...
#endif // STANDALONE_TRAJECTORY_TRACKING_PROCESSOR_HH_
